-- based on https://github.com/AstroNvim/astrocommunity/blob/main/lua/astrocommunity/pack/ansible/init.lua
-- but without ansible-lint because this is integrated in ansiblels
